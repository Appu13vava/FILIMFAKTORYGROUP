...
PICS = (environ.get('PICS', 'https://telegra.ph/Filimfaktory-12-07')).split()
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adaa™]https://t.me/+9hpzSIMAO_YyYjU9)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [MoviesAdda™](https://t.me/real_MoviesAdda2)</b> ↭  🔥")
...
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1002117099524")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
...
CAPTION_BUTTON_URL = "https://t.me/+9hpzSIMAO_YyYjU9"
...
# Born to make history FILIMFAKTORY!
